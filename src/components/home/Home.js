        ...
        [
            ...
            <div>
                <Card className="bg-dark">
                    ...
                    <Card.ImgOverlay>
                        <Card.Title className="border border-dark border-1"><h1 className="mt-0 fw-bold text-danger">Welcome To My</h1>
                            <h2 className="fw-bold text-light">Online Teaching Home</h2></Card.Title>
                        <Card.Text></Card.Text>
                    </Card.ImgOverlay>
                </Card>
            </div>,
            ...
            <div className="mt-5">
                ...
                <div className="d-flex justify-content-center flex-wrap bg-info border border-light">
                    {
